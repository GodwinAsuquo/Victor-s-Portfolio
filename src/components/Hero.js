  ...
  return (
    <section id="hero" className="dark:bg-[#0D0D0D]">
      <div className="container mx-auto flex flex-col items-center py-28 md:py-48  dark:text-white">
        ...
        <button
          onClick={handleClick}
          className="hidden md:flex text-white dark:text-black mt-16 items-center text-lg bg-black dark:bg-[rgb(242,242,247)] px-8 py-4 space-x-2 rounded-[3px]"
        >
          <p> See My Projects</p> <FiChevronDown />
        </button>
        <button
          onClick={handleClick}
          className="md:hidden text-white dark:bg-[rgb(242,242,247)] dark:text-black mt-16 flex items-center text-lg bg-black dark:bg- px-8 py-4 space-x-2 rounded-r-lg rounded-tl-lg"
        >
          <p> See My Projects</p>
          <FiChevronDown />
        </button>
