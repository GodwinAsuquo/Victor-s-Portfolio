...
useEffect(()=>{
  ...
  return (
    <div  className={`fixed bg-[${navColor}] shadow-sm dark:bg-[#131313] px-10 py-5 w-full mx-auto flex items-center z-10 text-base md:text-lg`}>
      <Link to='/home'>
       <h4 className={`tracking-wider md:text-xl text-[${backgroundColor}] dark:text-white font-semibold`}>VICTOR ASUQUO</h4>
      </Link>
